...
class Config(object):
  ...
  SHORTLINK_URL = os.environ.get('SHORTLINK_URL', "https://tinyurl.com")
  SHORTLINK_API = os.environ.get('SHORTLINK_API', "1Bfzb9rMAUgbTW6r9UGIUBcg0pshJbtX4hXzFIzjs9yifwNPxnqHtgpKBGad")
