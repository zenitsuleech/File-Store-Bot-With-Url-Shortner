...
class Config(object):
  ...
  SHORTLINK_URL = os.environ.get('SHORTLINK_URL', "https://t.ly/OtakuGuardian")
  SHORTLINK_API = os.environ.get('SHORTLINK_API', "HcyY6aetVyYVnRSANwdUtha6lam7KAvb7UpgEJEC5HvOasaUdigyu9LNXEQ5")
